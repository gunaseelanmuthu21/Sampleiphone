...
public class Main {
    ...
    public void test_11() throws FileNotFoundException{
        ...
        Scanner inputStream = new Scanner(new File("/Users/mcc1/Desktop/Demo/fgdemo.csv"));
        ...
        if(client.waitForElement("default", "element 0", 0, 10000)){
            // If statement
        }
        ...
        client.click("NATIVE", "xpath=//*[@text='Return to MD Flight Bag']", 0, 1);
        if(client.waitForElement("default", "element 3", 0, 30000)){
            // If statement
        }
        ...
        if(client.waitForElement("NATIVE", "xpath=//*[@placeholder='Password']", 0, 20000)){
            // If statement
        }
        client.elementSendText("NATIVE", "xpath=//*[@placeholder='Password']", 0, csvPassword);
        client.click("NATIVE", "xpath=//*[@text='Log In']", 0, 1);
        if(client.waitForElement("NATIVE", "xpath=//*[@text='Return to MD Flight Bag']", 0, 30000)){
            // If statement
        }
        client.click("NATIVE", "xpath=//*[@text='Return to MD Flight Bag']", 0, 1);
    }
